...
- [CO] Colombia added following the MX structure. Cédula de Ciudadanía is accepted as exactly a 10-digit string; the simulated bank score is derived from bank debt relative to monthly income; intake uses the MX-style 30× amount-to-income review rule.
